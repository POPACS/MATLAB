...
%Lese inn PICIS data
cd('M:\POPACS\Matlab\Input\PICIS Uttrekk med væskedata')
[a,b,fys_raw] = xlsread(fil_f,'Måledata','A2:AA4000');
[a,b,med_raw] = xlsread(fil_f,'Medikamenter','A2:D100');
[a,b,bg_raw] = xlsread(fil_f,'Blodgass','A2:C500');
clearvars a b %sletter unødvendige variabler
...
%%%%%%% TIDSVARIABLER - Hente ut tidspunkter for primær tidsrekke:

[tidsrekke, time] = convertExceltime(fys_raw(:,1));
tidlengde = length(time); %Lengde på tidsvektor
